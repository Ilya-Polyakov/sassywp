...
function underscoresass_widgets_init() {
	register_sidebar( array(
		...
		'after_title'   => '</h2>',
        	...
        	register_sidebar( array(
		'name'          => esc_html__( 'Footer Widgets', 'underscoresass' ),
                                    'description' => __('Footer widget area appears in the footer of the site', 'underscoresass'),
		'id'            => 'sidebar-2',
		'description'   => '',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
...
function underscoresass_scripts() {
	...
	wp_enqueue_style('underscoresass-google-fonts', 'http://fonts.googleapis.com/css?family=Lato:400,100,400italic,700,900italic,900|PT+Serif:400,400italic,700,700italic');
                  ...
                  wp_enqueue_script( 'underscoresass-hide-search', get_template_directory_uri() . '/js/hide-search.js', array(jquery), '20150813', true );
                  
                  wp_enqueue_script( 'underscoresass-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

                  wp_enqueue_script( 'underscoresass-masonry', get_template_directory_uri() . '/js/masonry-settings.js', array('masonry'), '20150814', true );
